<section class="search-route" id="search-hotels-block">
        <div class="container">
            <div>
                <h2 class="title-page" tkey="hotel_order">Забронировать отель</h2>
                <div class="tabs-air">
...
<!--                                            <input type="text" class="form-control whence" id="country">-->
                                            <select class="form-control whence" id="country">
                                                ...
                                                <option value="Багамские">Багамские</option>
                                                ...
                                                <option value="Буркина">Буркина</option>
                                                ...
                                                <option value="Коморские">Коморские</option>
                                                <option value="Коста">Коста</option>
                                                ...
                                                <option value="Мальдивские">Мальдивские</option>
                                                <option value="Мальта">Мальта</option>
                                                <option value="Марокко">Марокко</option>
                                                <option value="Маршалловы">Маршалловы</option>
                                                ...
                                                <option value="Сан">Сан</option>
                                                <option value="Сан">Сан</option>
                                                <option value="Саудовская">Саудовская</option>
                                                <option value="Свазиленд">Свазиленд</option>
                                                <option value="Сейшельские">Сейшельские</option>
                                                <option value="Сенегал">Сенегал</option>
                                                <option value="Сент">Сент</option>
                                                <option value="Сент">Сент</option>
                                                <option value="Сент">Сент</option>
                                                ...
                                                <option value="Федеративные">Федеративные</option>
                                                ...
                                                <option value="Шри">Шри</option>
                                                <option value="Эквадор">Эквадор</option>
                                                <option value="Экваториальная">Экваториальная</option>
                                                <option value="Эритрея">Эритрея</option>
                                                <option value="Эстония">Эстония</option>
                                                <option value="Эфиопия">Эфиопия</option>
                                                <option value="ЮАР">ЮАР</option>
                                                <option value="Южная">Южная Осетия</option>
                                                <option value="Южный">Южный Судан</option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="start-date" tkey="start-date">Въезд</label>
                                            <input type="date" class="form-control start-date" id="start-date-hotels">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="end-date" tkey="end-date">Отъезд</label>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div id="result" class="modal-body result">
        <p class="status-message">Нет гостиниц с такими параметрами</p>
          <table class="table table-bordered result-search">
              <thead>
              <tr>
                  <th tkey="country">Страна</th>
                  <th tkey="city">Город</th>
                  <th tkey="start-date">Дата вылета</th>
